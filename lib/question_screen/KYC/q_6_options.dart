...
class KYC6Option extends StatefulWidget {
  const KYC6Option(int optionIndexKYC, {super.key});

  @override
  State<KYC6Option> createState() => _KYC6OptionState();
}

class _KYC6OptionState extends State<KYC6Option> {
  @override
